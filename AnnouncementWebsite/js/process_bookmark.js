...
function addBookmark(jsonData) {
    ...
    var data = "username=" + jsonData.user + "&tenderReferenceNumber=" + jsonData.tenderRef + "&tenderTitle=" + jsonData.tenderTitle + "&originatingSource=" + jsonData.originatingSource + "&closingDate=" + jsonData.closingDate;
    xmlHttp.send(data);   
}
