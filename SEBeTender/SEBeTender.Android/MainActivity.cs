...
{
    [Activity(Label = "Pocket Tender", Icon = "@drawable/pt_logo", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
